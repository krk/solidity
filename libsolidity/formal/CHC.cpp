...
void CHC::visitBranch(Statement const& _statement, smt::Expression const& _predicate)
{
...
void CHC::query(smt::Expression const& _query, langutil::SourceLocation const& _location, std::string _description)
{
